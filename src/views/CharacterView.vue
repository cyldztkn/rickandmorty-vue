...
import CharacterPageContent from '@/components/character/CharacterPageContent.vue'
import ErrorScreen from '@/components/generic/ErrorScreen.vue'
...
<template>
  ...
  <CharacterPageContent v-if="path <= 826" />
  <ErrorScreen v-if="path > 826" />
</template>
